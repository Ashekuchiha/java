...
public class print extends javax.swing.JFrame {
    ...
    public print(String sub,String pay,String bal,TableModel tableModel) throws PrinterException {
        ...
        txtPrint.setText(txtPrint.getText()+"sub \t"+lsub+"pay \t"+lpay+"bal \t"+lbal+"\n");
        ...
        for(int i = 0;i<tableModel.getRowCount();i++){
            ...
            txtPrint.setText(txtPrint.getText()+"product : "+product+"price :\t"+price+"total : \t"+total+"\n");
        }
        
        txtPrint.setText(txtPrint.getText()+"sub \t"+sub+"pay \t"+pay+"bal \t"+bal+"\n");
